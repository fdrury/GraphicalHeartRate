...
class GraphicalHeartRateView extends Ui.DataField {
    ...
    function onUpdate(dc) {
        ...
        if(currentHR != null && currentHR != HR_NOT_SET){
        	...
        	dc.drawText( dc.getWidth() / 2, dc.getHeight() - 35, Gfx.FONT_LARGE, currentHR, Gfx.TEXT_JUSTIFY_CENTER );
        }
   	...
   	function plotHRData(dc) {
   		//accounting for curvature of round watch faces here would be cool... But difficult
